...
public class PakkumineView {
	private Integer id;
	private String nimetus;
	private Integer hind;
	private String kirjeldus;
	private Periood periood;
	public PakkumineView() {
		
	}
	
	public PakkumineView(Integer id, String nimetus, Integer hind, String kirjeldus, Periood periood) {		
		this(nimetus, hind, kirjeldus, periood);
		this.id = id;
		
		//this.pakkuminenimi = "Max voimsus: " + voimsus.toString() + "kW";
	}
	public PakkumineView(String nimetus, Integer hind, String kirjeldus, Periood periood) {
	...
	public String toString() {
		return "PakkumineView [id=" + id + ", nimetus=" + nimetus + ", hind=" + hind + ", kirjeldus=" + kirjeldus
				+ ", periood=" + periood + "]";
	}
