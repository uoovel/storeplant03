...
public class ConsumedEnergy {
	...
	public ConsumedEnergy(Integer id, Integer arvestiid, Timestamp alates, 
	...
	public ConsumedEnergy(Integer arvestiid, Timestamp alates, 
			Timestamp kuni, Integer energia, Integer hind, 
			Integer summa, String perNimetus, Integer perioodid) {
	...
	public String toString() {
		return "ConsumedEnergy [id=" + id + ", arvestiid=" + arvestiid + ", alates=" + alates + ", kuni=" + kuni
