...
public class ArvestiNait {
	...
	public ArvestiNait(Integer id, Integer arvestinaitid, Integer arvestiid, Timestamp aeg, Integer energia) {		
		this(arvestinaitid, arvestiid, aeg, energia);
		this.id = id;
	}
	public ArvestiNait(Integer arvestinaitid, Integer arvestiid, Timestamp aeg, Integer energia) {
	...
	public String toString() {
		return "ArvestiNait [id=" + id + ", arvestinaitid=" + arvestinaitid + ", arvestiid=" + arvestiid + ", aeg="
				+ aeg + ", energia=" + energia + "]";
	}
