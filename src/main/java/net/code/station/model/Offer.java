...
public class Offer {
	...
	public Offer(Integer id, String nimetus, Integer hind, String kirjeldus, Integer perioodid) {		
		this(nimetus, hind, kirjeldus, perioodid);
		this.id = id;
		
		//this.pakkuminenimi = "Max voimsus: " + voimsus.toString() + "kW";
	}
	public Offer(String nimetus, Integer hind, String kirjeldus, Integer perioodid) {
